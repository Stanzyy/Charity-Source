...
(13, 'AmeriCares Foundation', 620, 622, 99, 98, 100, 'We respond to disasters, the ones you see and the ones you dont. When an injured child is pulled from the rubble of a massive earthquake or an expectant mom struggles without health insurance, we are there with aid that restores health and saves lives.  When poverty, disease, or deadly conflict cause health crises, we deliver medicines, medical supplies and humanitarian aid to a trusted network of clinics, hospitals and health care providers around the world. We also create and support programs that increase capacity, improve quality and provide more access to health care in the world’s poorest countries and here in the U.S.', 'AmeriCaresFoundation.png', 'americaresfoundation'),
