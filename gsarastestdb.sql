...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 21, 2015 at 06:52 PM
...
(7, 1, 'American Red Cross', 10),
(8, 1, 'Task Force for Global Health', 10),
(9, 1, 'Task Force for Global Health', 10),
(10, 1, 'American Red Cross', 10),
(11, 1, 'Salvation Army', 10),
(12, 1, 'Boys and Girls Club of America', 10);
...
(1, 'anon@gmail.com', 'anon', 'anon', 'anon', 260),
(2, 'bob@gmail.com', 'bobo', 'bob', 'boberson', 10),
(3, 'dragid909@yahoo.com', 'cats', 'Shauna', 'Thompson', 0),
(4, 'kate.carcia@gmail.com', 'hello', 'Kaitlyn Hi', 'Carcia', 0);
...
--
ALTER TABLE `donations`
MODIFY `count` mediumint(6) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT for table `login`
--
ALTER TABLE `login`
MODIFY `loginNum` mediumint(9) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
