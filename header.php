                ...
                <li><div class="headerLogin">
                    <?php
                        if(!isset($_SESSION["loggedIn"]) || !$_SESSION["loggedIn"]){
                            ...
                            echo "<a href='userPage.php?username=".$_SESSION['userName']."'><span id='uname' style='color:white'>Hi ".$_SESSION['firstName'] . "</span></a> | <p id='logout' style='color:white'>Log Out</p>";
                        }            
                    ?>
                    </div></li>
